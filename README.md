...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Initial findings illustrate disparities between MM educational research funded by IES and those that were not in regards to reporting qualitative analysis methods. Among the journal articles in the sample of studies, 91.41% (N = 234 articles) reported a process of qualitative coding or analysis whereas the research funded by IES only 13.22% (N = 39 documents) disclosed a type of qualitative analysis. A statistically significant difference exists between MM educational journal articles and IES funded studies in terms of reporting a form of qualitative data analysis ( <img src="https://render.githubusercontent.com/render/math?math=$\chi^{2}$(1)= 348.68,p < .05) where journal articles informed the reader which qualitative method they will use more frequently. This elicits the degree in which IES mixed methodology is lagging with respect to effectively communicating a qualitative research strand, which is key when justifying a MM research design.
